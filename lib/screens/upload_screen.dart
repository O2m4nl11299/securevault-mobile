    ...
    return Column(
      ...
      children: [
        ...
        if (result.vaultLink1 != null && result.vaultLink2 != null) ...[
          ...
          const SizedBox(height: 12),
          Text(l.upVaultLink1, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
          const SizedBox(height: 4),
          Container(
            ...
            child: SelectableText(result.vaultLink1!, style: const TextStyle(fontFamily: 'monospace', fontSize: 12)),
          ),
          const SizedBox(height: 8),
          FilledButton.icon(
          ...
          const SizedBox(height: 16),
          Text(l.upVaultLink2, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
          const SizedBox(height: 4),
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
            ...
            child: SelectableText(result.vaultLink2!, style: const TextStyle(fontFamily: 'monospace', fontSize: 12)),
          ),
          const SizedBox(height: 8),
          OutlinedButton.icon(
