...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get kvkkP1 =>
      'Pursuant to Turkish Law No. 6698 on the Protection of Personal Data (\"KVKK\"), Fatih Göktürk (\"SecureVault\" or the \"Company\") processes the limited personal data described below in accordance with the law and the principle of good faith.';
  ...
  @override
  String get kvkkP2a =>
      'Our system is designed with a zero-knowledge architecture, aiming to keep your personal data to an absolute minimum. Accordingly, the categories of data processed are as follows:';

  @override
  String get kvkkP2b =>
      '• Username / Account Information — Stored irreversibly hashed with the SHA-256 algorithm; the original text is not kept on the server. Retention period: as long as the account is active; automatically deleted after 90 days of inactivity.\n• Account Password — Stored hashed with the Argon2id cryptographic function; your plaintext password never reaches the server. Retention period: until the account is deleted.\n• IP Address (Session Security) — Kept as a SHA-256 hash in an in-memory database (Redis) for the purpose of concurrent session/IP verification. Retention period: at most 24 hours, after which it is automatically and permanently deleted.\n• Login Access Record (IP + Account + Time) — For the purposes of preventing misuse of the Service, providing deterrence, and enabling disclosure to competent judicial/administrative authorities upon lawful request; your IP address (in plain text), the irreversible hash value of your account, and the login time are kept in a separate security record for each login to your account. Retention period: 90 days (3 months), after which it is automatically and permanently deleted.\n• Recipient\'s Email Address — Processed instantly, solely at the User\'s request, to send the download link by email; not stored in the database, destroyed immediately.\n• Subscription and Payment Data — Since payments are made through Google Play, your financial data is not kept by us; only the subscription status verification tokens generated by Google and your membership level are processed. Retention period: for the duration of the subscription and as required by applicable financial obligations.\n• File Content — Although not considered personal data, files uploaded are encrypted on your device before reaching the server; the Company cannot access the content. Retention period: permanently deleted the moment it is downloaded, or within a maximum of 1 hour if not downloaded.';

  @override
  String get kvkkH3 => '3. PURPOSES OF PROCESSING AND LEGAL GROUNDS';

  @override
  String get kvkkP3 =>
      'Your personal data is processed on the following legal grounds pursuant to Article 5/2 of the KVKK:\n• Establishment and Performance of a Contract (Art. 5/2-c): Creation of the user account, provision of the Premium subscription service through Google Play Store integration, and the operation of the file transfer service.\n• Legitimate Interest of the Data Controller (Art. 5/2-f): Processing of IP addresses and login records for the purpose of preventing misuse of the Service, ensuring cyber security (e.g., DDoS attacks, bot access), and providing deterrence.\n• Compliance with a Legal Obligation (Art. 5/2-ç): Sharing the login access records in our possession with competent judicial and administrative authorities upon their lawful request.';

  @override
  String get kvkkH4 =>
      '4. TRANSFER OF PERSONAL DATA AND CROSS-BORDER TRANSFER NOTICE';

  @override
  String get kvkkP4 =>
      'SecureVault carries out its technical operations and encrypted data hosting through the Cloudflare R2 cloud infrastructure. Your encrypted data blocks, together with the limited account data described above (SHA-256 hashes), are transferred abroad because the data center infrastructure is located outside Turkey. In addition, for the purpose of carrying out subscription processes, subscription verification tokens are shared reciprocally with Google Play Store (Google LLC, USA) systems. These transfers are carried out securely on the basis of the User\'s explicit in-app consent and the standard contractual clauses (SCC) entered into with the relevant service providers, within the scope of Article 9 of the KVKK. Your data is never transferred to local third parties or advertising companies. Upon a duly lawful request from competent judicial/administrative authorities, the login access records described above (Article 2) may be shared with the relevant authorities.';

  @override
  String get kvkkH5 => '5. RIGHTS OF THE DATA SUBJECT AND HOW TO APPLY';

  @override
  String get kvkkP5 =>
      'Pursuant to Article 11 of the KVKK, you have the right to learn whether your personal data is being processed, to request information if it has been processed, and to request its deletion or correction. Since your plaintext data (such as your username) is hashed due to our security architecture, in order to verify your identity you may submit your request directly through the \"Delete My Account\" button within the app, or contact us at destek@sifreliveritransferi.com to exercise your legal rights.';
